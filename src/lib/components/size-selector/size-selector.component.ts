...
@Component({
	...
	standalone: true,
	imports: [MatExpansionModule, MatCardModule, MatButtonModule, MatIconModule, MatDividerModule],
...
export class SizeSelectorComponent {
	...
	private readonly expansionPanel = viewChild<MatExpansionPanel>('panel');
