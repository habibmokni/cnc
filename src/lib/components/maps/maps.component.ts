...
export class MapsComponent {
	...
	public readonly mapWidth = input<number>(typeof screen !== 'undefined' ? screen.width : 400);
	...
	protected readonly storeLocations = computed(() => this.filteredData().locations);
	protected readonly directionsResult = computed(() => this.cncService.directionsResult());
	...
	protected readonly currentLocation = computed(() => this.cncService.currentLocation());
